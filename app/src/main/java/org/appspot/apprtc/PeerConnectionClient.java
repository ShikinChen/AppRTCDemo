...
public class PeerConnectionClient {
    ...
    public void setRemoteDescription(final SessionDescription desc) {
        executor.execute(() -> {
            ...
            if (preferIsac) {
                //MARK 启动iSAC https://zh.wikipedia.org/wiki/Internet_Speech_Audio_Codec
                //MARK 配置iSAC的sdp
            ...
            if (peerConnectionParameters.audioStartBitrate > 0) {
                //MARK 启动Opus https://zh.wikipedia.org/wiki/Opus_(%E9%9F%B3%E9%A2%91%E6%A0%BC%E5%BC%8F)
                sdp = setStartBitrate(
            ...
            //MARK 设置pc的远程sdp 调用nativeSetRemoteDescription层方法
            ...
            executor.execute(() -> {
                ...
                if (isInitiator) {
                    ...
                    if (peerConnection.getRemoteDescription() == null) {
                        ...
                        /**
                         * MARK demo的CallActivity#onLocalDescription(SessionDescription)方法
                         * @see CallActivity#onLocalDescription(SessionDescription)
                         */
